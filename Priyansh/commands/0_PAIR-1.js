...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache/canvas', 'pairing9.jpg');
...
async function makeImage({ one, two }) {
    ...
    let pairing_img = await jimp.read(__root + "/pairing9.jpg");
    ...
    pairing_img.composite(circleOne.resize(100, 150), 300, 300).composite(circleTwo.resize(900, 150), 300, 300);
